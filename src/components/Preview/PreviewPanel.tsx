...
export function PreviewPanel({ activeCase, cases, showResume, onResumeEnter, onResumeLeave }: PreviewPanelProps) {
  ...
  return (
    <main
      className="portfolio-section flex-[736_1_0%] min-w-0 h-full bg-[var(--color-preview)] rounded-[24px] overflow-hidden relative flex flex-col shadow-[0_0_6px_rgba(0,0,0,0.11)]"
