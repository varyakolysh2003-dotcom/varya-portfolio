...
interface SidebarProps {
  ...
  onResumeEnter: () => void;
  onResumeLeave: () => void;
  onCasesBlockEnter: () => void;
  onCasesBlockLeave: () => void;
}
...
export function Sidebar({
  ...
  return (
    <aside
      className="w-full lg:flex-[606_1_0%] min-w-0 lg:max-w-[606px] overflow-y-hidden hover:overflow-y-auto no-scrollbar scroll-smooth px-[6px]"
      onMouseEnter={onCasesBlockEnter}
      onMouseLeave={onCasesBlockLeave}
    >
