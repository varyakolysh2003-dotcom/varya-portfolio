                    ...
                    <div className="order-2 md:order-1 flex flex-col gap-[8px]" style={{ padding: '24px' }}>
                      ...
                      <div className="flex flex-col gap-[8px] text-[16px] font-medium text-[var(--color-text-secondary)]">
                        {activeTbankTestChip === 1 ? (
                          ...
                          <>
                            <p style={{ margin: 0 }}>{locale === 'ru' ? typograph('— Текст заголовка «Кредитная карта» после открытия формы вызвал тревогу и\u00A0ассоциации с\u00A0обязательным оформлением кредитной карты') : typograph('— The heading "Credit card" after opening the form caused anxiety and associations with mandatory credit card sign-up')}</p>
