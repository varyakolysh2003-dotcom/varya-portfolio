                        ...
                        >
                          <img loading="lazy"
                            ...
                            style={{
                              height: '460px',
                              width: 'auto',
                              borderRadius: 'calc(var(--radius-media) - 20px)',
                              display: 'block',
                      ...
                      {[21, 22].map((n) => (
                        <div key={n} className="snap-center flex-shrink-0 w-full h-full flex items-center justify-center">
                          <img loading="lazy"
                            ...
                            style={{ height: '460px', width: 'auto', borderRadius: 'calc(var(--radius-media) - 20px)', display: 'block', boxShadow: '0 8px 28px rgba(0,0,0,0.10)' }}
                          />
                        </div>
                      ))}
                    </div>
